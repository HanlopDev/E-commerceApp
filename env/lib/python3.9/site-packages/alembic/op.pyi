...
def drop_table(table_name: str, schema: Optional[str] = None, **kw: Any) -> None:
...
def inline_literal(value: Union[str, int], type_: None = None) -> "_literal_bindparam":
...
def register_operation(name: str, sourcename: Optional[str] = None) -> Callable:
