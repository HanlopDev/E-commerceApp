...
def _compare_indexes_and_uniques(
    ...
    metadata_indexes_sig = set(_ix_constraint_sig(ix) for ix in metadata_indexes)
...
def _compare_foreign_keys(
    ...
    backend_reflects_fk_options = bool(conn_fks_list and "options" in conn_fks_list[0])
    ...
    conn_fks_by_name = dict((c.name, c) for c in conn_fks_sig if c.name is not None)
